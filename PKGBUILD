...
source=("ftp://ftp.denx.de/pub/u-boot/u-boot-${pkgver/rc/-rc}.tar.bz2"
        ...
        "0004-dts-rockchip-rk3399-enable-emmc-phy-for-spl.patch"
...
prepare() {
  ...
  # Patches based on the work of dhivael, Nadia and Yifeng
  ...
  patch -Np1 -i "${srcdir}/0004-dts-rockchip-rk3399-enable-emmc-phy-for-spl.patch"                      # Missing eMMC PHY
